...
_C.DATA.PATH = CN()
_C.DATA.PATH.TRAIN_DIR = 'data/train_images'
_C.DATA.PATH.VAL_DIR = 'data/train_images'
_C.DATA.PATH.TEST_DIR = None
_C.DATA.PATH.TRAIN_CSV = 'data/train_labels.csv'
_C.DATA.PATH.VAL_CSV = 'data/val_labels.csv'
_C.DATA.PATH.TEST_CSV = None
